...
Kraft Furlong 115: "Because public problems can be understood only through the insights of many disciplines, policy analysis draws from the ideas and methods of economics, political science, sociology, psychology, philosophy, and other scientific and technical fields."
...
TODO: Merging of multiple disciplinary traditions: political science/public administration and economics/econometrics


In quantitative statistical analysis, analysts are typically concerned with both (1) the characteristics or distribution of social phenomena on their own and (2) in the relationships between multiple phenomena. Different disciplines and analytical traditions use varying terms to define these variables—@tbl-methods-summary offers some disambiguation for these concepts.
...
2. **Explanation**, where the focus of the analysis is on explanatory variables ($X$) to either (1) accurately estimate their relationship with an outcome variable ($Y$), or (2) causally attribute the effect of specific explanatory variable on outcomes [@Shmueli:2010; @Breiman:2001; @Efron:2020; @MorganWinship:2014; @AngristPischke:2008; @PearlMackenzie:2020]
...
These categories provide a useful shorthand for describing different purposes of analysis, but these approaches are rarely mutually exclusive. Descriptive exploratory work is necessary for both explanatory and predictive analysis, and the division between causal and non-causal inference is rarely clear-cut and depends strongly on identifying assumptions and internal, external, and construct validity [@EsterlingBradySchwitzgebel:2025].
...
Description occurs in both approaches and looks at just $X$, just $Y$, and the general relationship between the two

Description forms the foundation of all quantitative policy analysis by examining distributions, patterns, and relationships in data without necessarily making causal claims. 

Univariate description: Examining single variables using summary statistics (central tendency, dispersion), visualizations (histograms, density plots), and data transformations.

Mapping poverty rates across counties, describing trends in healthcare spending over time

Multivariate description: Exploring relationships between variables through correlation analysis, cross-tabulations, and visualization techniques.

Identifying associations between education funding and student outcomes, examining demographic patterns in policy support
...
Stuff on estimation strategies—summary statistics, means, medians, etc.
